    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBHelper dbh = new DBHelper(EditFood.this);
                dbh.deleteFood(data.getId());
                dbh.close();
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DBHelper dbh = new DBHelper(EditFood.this);
                data.setLocation(etLocation.getText().toString());
                data.setAddress(etAddress.getText().toString());
                data.setDate(etDate.getText().toString());
                data.setBestdish(etdish.getText().toString());
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Toast.makeText(EditFood.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    iv.setImageBitmap(bitmap);

                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(EditFood.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
